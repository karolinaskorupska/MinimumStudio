...
function minimumStudio_register_styles(){
    ...
    wp_enqueue_style('minimumstudio-style', get_template_directory_uri()."/site-template/css/style.css", array("minimumstudio-fontawesome"), $version, 'all');
...
function minimumStudio_register_scripts(){
    ...
    wp_enqueue_script('minimumstudio-script', get_template_directory_uri()."/site-template/main.js/", array(), '1.0', true);
